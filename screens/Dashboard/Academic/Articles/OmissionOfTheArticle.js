...
const OmissionOfTheArticle = () => {
  return (
    ...
    <ScrollView>
        ...
        <Text style={styles.text}>* But an Article may be used, <BoldTextHelper text="if these qualities are attributed to people."/></Text>
        ...
        <Text style={styles.text}>1. Kalidas is <UnderlineTextHelper text="the"/> <BoldTextHelper text="Shakespeare"/> <UnderlineTextHelper text="of"/> India.</Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="The"/> <BoldTextHelper text="beauty"/> <UnderlineTextHelper text="of"/> <BoldTextHelper text="kashmir"/> is remarkable.</Text>
        <Text style={styles.text}>3. <UnderlineTextHelper text="The"/> <BoldTextHelper text="gold"/> <UnderlineTextHelper text="of"/> <BoldTextHelper text="Kollar field"/> is not of high quality.</Text>
        <Text style={styles.text}>4. <BoldTextHelper text="The"/> <UnderlineTextHelper text="milk"/> <UnderlineTextHelper text="in"/> <BoldTextHelper text="the cup"/> has turned sour.</Text>
        <Text style={styles.text}>5. <BoldTextHelper text="The"/> <UnderlineTextHelper text="wisdom"/> <UnderlineTextHelper text="of"/> <BoldTextHelper text="Solomon"/> was known far and wide. </Text>
        </View>
        ...
        <Text style={styles.text}>1. <UnderlineTextHelper text="The"/> school is very near to my house. </Text>
        <Text style={styles.text}>2. I met him at <UnderlineTextHelper text="the"/> church.</Text>
        <Text style={styles.text}>3. <UnderlineTextHelper text="The"/> bed is broken. </Text>
        <Text style={styles.text}>4. <UnderlineTextHelper text="The"/> college is very beautifully constructed.</Text>
        <Text style={styles.text}>5. I went to <UnderlineTextHelper text="the"/> hospital to see my friend.</Text>
        <Text style={styles.text}>6. <UnderlineTextHelper text="The"/> market is closed. </Text>
        ...
        <Text style={styles.text}>1. <UnderlineTextHelper text="X"/> Mother gave birth to me. </Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="X"/> Father is coming today. </Text>
        <Text style={styles.text}>3. <UnderlineTextHelper text="X"/> Children make every home a happy family. </Text>
        <Text style={styles.text}>4. <UnderlineTextHelper text="X"/> Aunt wants you to see her.</Text>
        <Text style={styles.text}>5. <UnderlineTextHelper text="X"/> Cook is in the kitchen.</Text>
        <Text style={styles.text}>6. <UnderlineTextHelper text="X"/> Nurse is very kind. </Text>
        <Text style={styles.text}>7. <UnderlineTextHelper text="X"/> Man is a social animal.</Text>
        <Text style={styles.text}>8. <UnderlineTextHelper text="X"/> Woman is clever than X man.</Text>
        ...
        <Text style={styles.text}>1. He invited me to <UnderlineTextHelper text="X"/> dinner.</Text>
        <Text style={styles.text}>2. I usually have <UnderlineTextHelper text="X"/> lunch at twelve. </Text>
        <Text style={styles.text}>3. I am late for <UnderlineTextHelper text="X"/> dinner.</Text>
        <Text style={styles.text}>4. I shall return for <UnderlineTextHelper text="X"/> supper.</Text>
        <Text style={styles.text}>5. I take <UnderlineTextHelper text="X"/> breakfast quite early.</Text>
        <Text style={styles.text}>6. What time do you have <UnderlineTextHelper text="X"/> lunch? </Text>
        <Text style={styles.text}>7. <UnderlineTextHelper text="X"/> Dinner is ready?</Text>
        ...
        <Text style={styles.text}>1. I had <UnderlineTextHelper text="a"/> late lunch today.</Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="The"/> dinner we had at the Tourist Hotel was very nice.</Text>
        <Text style={styles.text}>3. <UnderlineTextHelper text="The"/> dinner will be held at Grand Hotel.</Text>
        <Text style={styles.text}>4. We enjoyed <UnderlineTextHelper text="the"/> breakfast she gave us.</Text>
        </View>
        ...
        <Text style={styles.text}>1. He is suffering from <UnderlineTextHelper text="X"/> fever.</Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="X"/> AIDS is an incurable disease. </Text>
        <Text style={styles.text}>3. <UnderlineTextHelper text="X"/> Cholera has broken out.</Text>
        <Text style={styles.text}>BUT:  The plague.</Text>
        <Text style={styles.text}>NOTE</Text>
        <Text style={styles.text}>1. A. Raju is suffering from <UnderlineTextHelper text="a"/> head ache.</Text>
        <Text style={styles.text}>2. Sita is suffering from <UnderlineTextHelper text="a"/> stomach ache / tooth ache.</Text>
        <Text style={styles.text}>3. She has <UnderlineTextHelper text="an"/> ear ache. </Text>
        ...
        <Text style={styles.text}>1. My brother plays <UnderlineTextHelper text="X"/> chess in leisure. </Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="X"/> cricket is a popular game in the world.</Text>
        <Text style={styles.text}>3. They fond of <UnderlineTextHelper text="X"/> football.</Text>
        ...
        <Text style={styles.text}>1. <UnderlineTextHelper text="X"/> March is the third month of the year.</Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="X"/> Monday comes after Sunday. </Text>
        <Text style={styles.text}>3. We go to Kashmir in <UnderlineTextHelper text="X"/> summer.</Text>
        <Text style={styles.text}>5. I don’t travel in <UnderlineTextHelper text="X"/> winter.</Text>
        ...
        <Text style={styles.text}>1. <UnderlineTextHelper text="X"/> Society will not permit it.</Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="X"/> Parliament is in sessions.</Text>
        <Text style={styles.text}>3. <UnderlineTextHelper text="X"/> Jury has given its verdict.</Text>
        <Text style={styles.text}>4. <UnderlineTextHelper text="X"/> Army is on the move.</Text>
        ...
        <Text style={styles.text}>1. <UnderlineTextHelper text="X"/> Nature is the best physician.</Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="X"/> society is a combination of all sections of people.</Text>
        <Text style={styles.text}>3. Wordsworth is a worshiper of <UnderlineTextHelper text="X"/> Nature.</Text>
        <Text style={styles.text}>4. <UnderlineTextHelper text="X"/> Society is created for the welfare of man.</Text>
        ...
        <Text style={styles.text}>1. I know <UnderlineTextHelper text="X"/> English.</Text>
        <Text style={styles.text}>2. He knows <UnderlineTextHelper text="X"/> French.</Text>
        <Text style={styles.text}>3. They speak <UnderlineTextHelper text="X"/> Punjabi at home.</Text>
        <Text style={styles.text}>NOTE. 1: A. He is good at <UnderlineTextHelper text="the"/> English language.</Text>
        <Text style={styles.text}>NOTE. 2: But put <UnderlineTextHelper text="THE"/> before Nouns which name the inhabitants of a country collectively or as a community, but not before their languages.</Text>
        <Text style={styles.text}>1. <UnderlineTextHelper text="The"/> French live in France and the Portuguese in Portugal.</Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="The"/> British. (British People)</Text>
        <Text style={styles.text}>3. <UnderlineTextHelper text="The"/> Germans.</Text>
        ...
        <Text style={styles.text}>1. <UnderlineTextHelper text="X"/> White stands for purity.</Text>
        <Text style={styles.text}>2. <UnderlineTextHelper text="X"/> Green is associated with prosperity.</Text>
        ...
        <Text style={styles.text}>1. He is coming on <UnderlineTextHelper text="X"/> Dasara.</Text>
        <Text style={styles.text}>2. She is going on <UnderlineTextHelper text="X"/> Christmas.</Text>
        ...
        <Text style={styles.text}>1. This is <UnderlineTextHelper text="X"/> my house.</Text>
        <Text style={styles.text}>2. He is <UnderlineTextHelper text="X"/> your friend.</Text>
        <Text style={styles.text}>3. These are <UnderlineTextHelper text="X"/> our cows.</Text>
        ...
        <Text style={styles.text}>1. This is an <UnderlineTextHelper text="old man’s"/> house. (not, old man’s house)</Text>
        <Text style={styles.text}>2. This is a <UnderlineTextHelper text="beggar’s"/> cottage.</Text>
        ...
        <Text style={styles.text}>1. There is no <UnderlineTextHelper text="boy"/> in the class. (not, a no boy)</Text>
        <Text style={styles.text}>2. She has not any <UnderlineTextHelper text="chance"/>.</Text>
        <Text style={styles.text}>3. There is not any <UnderlineTextHelper text="egg"/>.</Text>
        ...
        <Text style={styles.text}>1. What kind of <UnderlineTextHelper text="X"/> chair do you want to buy?</Text>
        <Text style={styles.text}>2. I cannot deal with this sort of <UnderlineTextHelper text="X"/> man.</Text>
        ...
        <Text style={styles.text}>1. What kind of <UnderlineTextHelper text="a"/> musician is he?</Text>
        <Text style={styles.text}>2. What sort of <UnderlineTextHelper text="a"/> problem would you discuss? </Text>

...
const UseOfPreposition = () => {
  return (
    <ScrollView>
      ...
      <Text style={{fontSize:16}}>Generally Prepositions are used <BoldTextHelper text="before their objects."/></Text>
      ...
      In the above sentences <BoldTextHelper text="on, in, of, from" inputStyle={{color:"green"}}/> are Prepositions and they have all been used before their objects <BoldTextHelper text="(table, office, tea, Delhi)." inputStyle={{color:"green"}}/> A Preposition may have <BoldTextHelper text="two or more than two objects." inputStyle={{color:"green"}}/> The Preposition will be used before the first of all these objects. As—
      </Text>
...
target="emphasis, object,beginning, Preposition, end"
        ...
        <HelperComponent inputText="2. This I insist on." target="This, on"/>
        <HelperComponent inputText="3. That you must speak out." target="That,out"/>
       ...
       <HelperComponent
        ...
        />
        <HelperComponent inputText="1. He can be relied upon." target="upon"/>
        <HelperComponent inputText="2. Was the proposal agreed to ?" target="to"/>

...
As—
      ...
      In this sentence <BoldTextHelper text="has"/> is auxiliary verb and <BoldTextHelper text="gone"/> Principal Verb. Here <BoldTextHelper text="has"/>  helped the Principal Verb in making its <BoldTextHelper text="Present Perfect Tense"/>, and in so doing it has lost its own identity as a Principal verb.
      </Text>


      <View style={{marginVertical:15}}>
      <Text style={{fontSize:17,fontWeight:"400",color:"red"}}>
